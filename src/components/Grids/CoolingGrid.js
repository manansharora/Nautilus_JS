...
const CoolingGrid = ({ column, deleteColumn, NewRow2, deleteRow2, handleEditFormChange, handleEditFormSubmit, setId, setGrid2, setCoolingGridHeader, Alert }) => {

    const setGrid = (header, key) => {
                                                        ...
                                                        {column.map((index, key2) => (
                                                            <React.Fragment key={key2}>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input type='text' name={`value${key2}`} style={{ backgroundColor: '#fff' }} className="form-control" defaultValue={NewRow2[key1][`value${key2}`] || ''} onChange={handleEditFormChange} onClick={(e) => setGrid(index.header, key2)} onKeyPress={(event) => {
