...
const MinFlowRate = () => {
    ...
    return (
        ...
        <Form>
            ...
            <Form.Group className="mb-3" controlId="formBasicnumber">
                <Form.Label>Min Required GPM for turbulent flow</Form.Label>
                <Col sm={10}>
                    <Form.Control name="materialDensity" type="number" value={shotSizeData.materialDensity} onChange={handleChange} disabled/>
                </Col>
            </Form.Group>
        </Form>
        </div>
